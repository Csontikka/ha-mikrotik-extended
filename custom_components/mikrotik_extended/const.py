"""Constants used by the MikroTik Extended component and platforms."""
...
DOMAIN = "mikrotik_extended"
DEFAULT_NAME = "MikroTik Extended"
...
DEFAULT_SENSOR_NAT = True
CONF_SENSOR_MANGLE = "sensor_mangle"
DEFAULT_SENSOR_MANGLE = True
CONF_SENSOR_ROUTING_RULES = "sensor_routing_rules"
DEFAULT_SENSOR_ROUTING_RULES = False
CONF_SENSOR_FILTER = "sensor_filter"
DEFAULT_SENSOR_FILTER = True
CONF_SENSOR_WIREGUARD = "sensor_wireguard"
DEFAULT_SENSOR_WIREGUARD = False
CONF_SENSOR_CONTAINERS = "sensor_containers"
DEFAULT_SENSOR_CONTAINERS = False
...
DEFAULT_SENSOR_NETWATCH_TRACKER = True
